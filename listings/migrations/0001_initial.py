# Generated by Django 3.2.3 on 2021-05-30 01:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_type', models.CharField(choices=[('sale', 'For Sale'), ('rent', 'For Rent')], default='For Sale', max_length=20)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('home_type', models.CharField(choices=[('house', 'House'), ('condo', 'Condo'), ('TownHouse', 'Townhouse')], default='Houses', max_length=50)),
